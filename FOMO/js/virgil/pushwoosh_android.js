...
function registerPushwooshAndroid() {
	...
	document.addEventListener('push-notification',
		function(event){
			console.log("push event: " + event.notification);
		}
	);
	...
	pushNotification.registerDevice({ projectid: "1003313618706", appid : "BD25D-34515" },
		function(token){
			//save token
			localStorage.setItem("pushwooshToken", token);
